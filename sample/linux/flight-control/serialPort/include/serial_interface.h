...
typedef enum:unsigned char {
    ...
    CMD_SERIAL_RELA_YUNTAI = 0x09,
    CMD_SERIAL_YUNTAI_DELTA_SET=0x10,
    CMD_SERIAL_YUNTAI_ABS_SET = 0x11,
    CMD_SERIAL_SHOOT=0x12,
    CMD_SERIAL_ABS_YUNTAI_DELTA = 0x13,
    CMD_SERIAL_ABS_YUNTAI_SMALL_DELTA = 0x14,
    CMD_SERIAL_YUNTAI_SMALL_DELTA_SET=0x15,
    CMD_SERIAL_YUNTAI_SMALL_ABS_SET=0x16,
    CMD_SERIAL_SMALL_SHOOT= 0x17,
